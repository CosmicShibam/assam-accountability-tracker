              ...
              {promise.sourceRef && (
                <div className="group clay-recessed bg-surface-container-low rounded-lg p-3 flex items-center gap-4 hover:bg-surface-container transition-colors">
                  ...
                  <div className="flex-grow">
                    <span className="block text-sm font-semibold text-on-surface group-hover:text-primary transition-colors line-clamp-1">{promise.sourceTitle || 'Official Source'}</span>
                    <span className="block text-xs font-medium text-on-surface-variant">Ref: {promise.sourceRef} • {promise.sourceDate}</span>
                  </div>
                </div>
              )}
              {!promise.sourceRef && (
