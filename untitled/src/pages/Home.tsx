...
import { Search, RotateCcw, Box, CheckCircle, RefreshCw, Hourglass, Building2, Bell, Gavel, HandHeart, Briefcase, BookOpen, Sprout, HeartPulse, TrendingUp } from "lucide-react";
...
export default function Home() {
  ...
  return (
    <div className="w-full max-w-[1280px] mx-auto px-4 sm:px-6 py-8 flex flex-col gap-12">
      <section className="flex flex-col items-center text-center mt-8">
        <button 
          onClick={() => window.location.reload()}
          className="inline-flex items-center gap-2 px-4 py-2 rounded-full clay-recessed text-primary text-xs font-medium mb-6 hover:bg-primary-container/20 transition-colors"
        >
          <RotateCcw size={16} className="active:animate-spin" /> Data updated recently
        </button>
        <h2 className="font-heading text-4xl md:text-5xl font-bold text-primary max-w-4xl mb-6 leading-tight">
          Tracking Progress, <br /><span className="text-tertiary-container">Building Trust</span>
        </h2>
        <p className="text-lg text-on-surface-variant max-w-2xl mb-12">
          A community-driven platform ensuring transparent accountability. Explore real-time status updates on civic commitments across infrastructure, education, and healthcare.
        </p>
        ...
        <form onSubmit={handleSearch} className="w-full max-w-2xl relative group">
          ...
          <input 
            ...
            placeholder="Search promises, districts, or categories..." 
            type="text" 
          />
      ...
      <section className="grid grid-cols-2 lg:grid-cols-4 gap-6">
        <div className="rounded-3xl p-6 flex flex-col items-center text-center bg-primary-container shadow-[10px_10px_20px_rgba(0,36,136,0.1),inset_4px_4px_10px_rgba(255,255,255,0.8),inset_-4px_-4px_12px_rgba(0,36,136,0.1)] border border-primary-container/50">
        ...
        <div className="rounded-3xl p-6 flex flex-col items-center text-center bg-secondary-container shadow-[10px_10px_20px_rgba(36,112,62,0.1),inset_4px_4px_10px_rgba(255,255,255,0.8),inset_-4px_-4px_12px_rgba(36,112,62,0.1)] border border-secondary-container/50">
        ...
        <div className="rounded-3xl p-6 flex flex-col items-center text-center bg-surface-container-high shadow-[10px_10px_20px_rgba(64,86,184,0.05),inset_4px_4px_10px_rgba(255,255,255,1),inset_-4px_-4px_12px_rgba(64,86,184,0.05)] border border-white">
        ...
        <div className="rounded-3xl p-6 flex flex-col items-center text-center bg-surface-variant shadow-[10px_10px_20px_rgba(68,70,82,0.1),inset_4px_4px_10px_rgba(255,255,255,0.8),inset_-4px_-4px_12px_rgba(68,70,82,0.1)] border border-white">
